 ...
 */
@ApiModel(value = "兑换详情")
public class CExchangeDetailDto {
    ...
    public CExchangeDetailDto() {
    }

    public CExchangeDetailDto(int id, Date createDate, String cardHolder, String bankName, String bankCardNo, String cShandian, String poundage, String sjdk, int state, int arrivalMode) {
        this.id = id;

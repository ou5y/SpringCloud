...
LN_S=ln -s -f
STRIP=strip
CPPFLAGS=-fexceptions -I/mingw/include -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1
CFLAGS=-DWINVER=0x0501 -D_WIN32_IE=0x0501 -fno-builtin -pipe -O2 -mms-bitfields -march=i686 -mtune=i686   -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=-DWINVER=0x0501 -D_WIN32_IE=0x0501 -fno-builtin -pipe -O2 -mms-bitfields -march=i686 -mtune=i686  -D__STDC_CONSTANT_MACROS
ASFLAGS=   -g
AS_C=-c
AS_O=-o $@
CC_C=-c
...
LD_PATH=-L
DLLTOOL=dlltool
LDFLAGS=-L/mingw/lib -Wl,--no-undefined -Wl,--export-all-symbols  -Wl,--nxcompat -Wl,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lavicap32 -lws2_32 -liconv -lm -lbz2 -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
